describe('colorChangingDancer', function() {
  ...
  it('should change the nodes color', function() {
    var color = colorChangingDancer.$node.css('border-color');
    colorChangingDancer.step();
    expect(colorChangingDancer.$node.css('border-color') !== color).to.be.true;
  });
